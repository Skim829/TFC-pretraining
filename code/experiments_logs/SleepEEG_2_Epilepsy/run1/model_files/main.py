...
# Load datasets
sourcedata_path = f"C:\\Users\\slon1\\Desktop\\BCC AI 주제 관련\\Data\\TF-C data\\{sourcedata}"  # './data/Epilepsy'
targetdata_path = f"C:\\Users\\slon1\\Desktop\\BCC AI 주제 관련\\Data\\TF-C data\\{targetdata}"
